// Wave 4 recalibration for "other" vertical (catch-all knowledge worker).
// 54 exercises x 10 goals x 3 archetypes (A/B/C) = 1,620 prompts.
// Authoring rules per docs/prompt-design-canon.md.
// Themes: meetings, deadlines, deliverables, stakeholders, async, recognition,
// career growth, WFH dynamics. Universal across knowledge workers.

import fs from "node:fs";

const CATALOG_PATH = "C:/Users/MaxVolkov/dev/cognify/scripts/exercise-catalog/v1/vertical/other.json";
...
// -----------------------------------------------------------------------------
// Universal A pool — 10 prompts per exercise. Pure mechanic, no scene.
// -----------------------------------------------------------------------------
const UNIVERSAL_A = {
  "Answer the Confusion": [
    "Someone pushes back on your point. What's the cleanest way to address it?",
    ...
    "Open with the answer or with the context?",
    "What's the question people are too afraid to ask out loud?",
  ...
  "Explain Like I'm 12": [
    ...
    "Explain the most important idea in your job — no jargon.",
    ...
    "Explain what learning at work actually is, in plain words.",
  ],
  "Headline First": [
    ...
    "If you had ten seconds with your boss, what would you say?",
  ...
  "Cut by Half": [
    ...
    "Say everything you'd say in a feedback chat. Now half it.",
    "What's the long pitch for what you believe? Now the short one.",
    "Talk about your day. Now make it half as long.",
    "Tell me everything you know about a stakeholder. Then compress.",
  ...
  "The Word Budget": [
    ...
    "Forty words: tell a true short story from work.",
  ...
  "Kill the Filler": [
    ...
    "Tell a true story from this week. No fillers.",
...
// -----------------------------------------------------------------------------
// Goal flavor — knowledge-work lens. Themes: meetings, deadlines, deliverables,
// stakeholders, async, recognition, career growth, WFH dynamics.
// -----------------------------------------------------------------------------
const GOAL_FLAVOR = {
  handling_objections: {
    bSeed: [
      "Why do most performance reviews tell you nothing useful?",
      "When a teammate says your idea won't work, what's your first move?",
      "What do you do when a stakeholder kills a deliverable late?",
      "How do you take pushback in a meeting without losing the room?",
      "What changes a colleague's mind faster — logic or trust?",
    ],
    cSeed: [
      "Push back on a deadline that doesn't make sense — without sounding difficult.",
      "Respond to 'this isn't what we asked for' on a piece of work you stand by.",
      "Push back on a scope change that landed in Slack with no context.",
      "Respond to a colleague who says your priorities are wrong — and is half right.",
      "Push back when your manager says the strategy is settled.",
    ],
  },
  confidence: {
    bSeed: [
      "What does confidence sound like on a Monday meeting with execs?",
      "Where does confidence at work actually come from?",
      "When does a knowledge worker know they've earned the room?",
      "What's the difference between confidence and loud certainty?",
      "What does confident async writing look like — really?",
    ],
    cSeed: [
      "Open a meeting where you're the most junior person at the table.",
      "Speak up first in a room full of people more senior than you.",
      "Defend a piece of work you put your name on, in front of leadership.",
      "Take the floor in a meeting that's been going sideways for ten minutes.",
      "Walk into a stakeholder review like you've done it a hundred times.",
    ],
  },
  thinking_on_the_spot: {
    bSeed: [
      "Someone asks you something in a meeting you don't know. What's your move?",
      "What do you do when the agenda breaks down in real time?",
      "How do you stay flexible when the meeting takes a turn you didn't plan?",
      "How do you think out loud in front of execs without losing the room?",
      "What's the right way to admit you don't know — on the spot?",
    ],
    cSeed: [
      "A teammate asks the question your slides didn't plan for. Answer.",
      "The screenshare fails mid-demo. Keep going.",
      "Someone offers a take that's better than yours mid-meeting. Respond.",
      "A stakeholder surprises you with a hard question right before lunch. Answer.",
      "Your boss asks you to summarize a project on the fly. Go.",
    ],
  },
  giving_feedback: {
    bSeed: [
      "Why do most performance reviews tell you nothing useful?",
      "What kind of feedback at work do people actually grow from?",
      "When does honest feedback do more harm than good?",
      "What's the difference between feedback that helps and feedback that stings?",
      "What's the best feedback you ever got — and why did it work?",
    ],
    cSeed: [
      "Give a teammate feedback on work that's trying hard and missing.",
      "Tell a colleague their tone in Slack is creating problems.",
      "Hand back a deliverable that's clearly rushed — without crushing the person.",
      "Tell a peer their meeting style is losing the room.",
      "Tell a direct report their effort isn't matching the bar.",
    ],
  },
  negotiation: {
    bSeed: [
      "What's worth fighting for in a deadline conversation, and what isn't?",
      "Where do you give and where do you hold in a salary review?",
      "What do you trade for scope when the timeline's fixed?",
      "How do you negotiate with a stakeholder who outranks you?",
      "What's the line between a good ask and a pushy one?",
    ],
    cSeed: [
      "A stakeholder wants the deliverable two weeks earlier. Negotiate.",
      "Your manager wants you to take on a second project. Hold or trade?",
      "A peer wants to swap responsibilities. Negotiate.",
      "A client wants a fix that's outside scope. Talk through it.",
      "Your team wants to cut a meeting from the calendar. Hold or trade?",
    ],
  },
  presenting: {
    bSeed: [
      "What makes a status update worth listening to?",
      "What separates a presenter who holds a room from one who doesn't?",
      "Why do most all-hands openings die in the first thirty seconds?",
      "What's an opening line that wakes a tired meeting up?",
      "What does a great presenter do in the first thirty seconds?",
    ],
    cSeed: [
      "Open a Monday meeting like the room actually wants to be there.",
      "Open a kickoff with a line people will remember in a week.",
      "Open a quarterly review without saying 'so, basically'.",
      "Open a deck you've shown five times — fresh.",
      "Open a meeting after the previous one ran ten minutes late.",
    ],
  },
  persuasion: {
    bSeed: [
      "What actually changes a colleague's mind?",
      "What changes a stakeholder's mind in a tough meeting?",
      "Why does data alone almost never move a decision?",
      "What's the most persuasive thing you can do in a meeting?",
      "What moves a budget owner more — numbers or a story?",
    ],
    cSeed: [
      "Convince a peer that the work is worth doing — even though it's boring.",
      "Convince a stakeholder to support a call they didn't make.",
      "Convince a teammate to try a new way of working with you.",
      "Convince a manager to back a risky bet.",
      "Convince a team to drop a project they've been carrying.",
    ],
  },
  storytelling: {
    bSeed: [
      "What's a true work moment that stays with you?",
      "What's a story you tell new hires about how things really work here?",
      "What's a small thing a colleague did that changed how you work?",
      "What's a story you tell about why you stayed in this job?",
      "What's a moment in a meeting that changed your mind?",
    ],
    cSeed: [
      "Tell a story about a project that turned around at the last minute.",
      "Tell a story about a deliverable that worked when you didn't expect it.",
      "Tell a story about a stakeholder meeting that surprised you.",
      "Tell a story about the first time you got real recognition at work.",
      "Tell a story about a quarter that almost broke you.",
    ],
  },
  asking_questions: {
    bSeed: [
      "What's a question that opens a quiet meeting?",
      "What's a question that gets a real answer from a stakeholder?",
      "What's a question worth asking in every 1:1?",
      "What's a question you stopped asking — and wish you hadn't?",
      "What's the best question you've ever asked a teammate?",
    ],
    cSeed: [
      "Ask a question in a meeting that gets the quiet person to talk.",
      "Ask a stakeholder the question that opens up the real concern.",
      "Ask a teammate the question they're avoiding.",
      "Ask a colleague who says 'it's fine' a better question.",
      "Ask a question that turns a one-word answer into a real conversation.",
    ],
  },
  explaining: {
    bSeed: [
      "What do most people over-explain in meetings?",
      "What's the difference between explaining and just talking?",
      "When does a good explanation make things worse?",
      "Why do colleagues tune out the second a deck loads?",
      "What's the simplest way to know your explanation landed?",
    ],
    cSeed: [
      "Explain a hard concept to a teammate who's already lost.",
      "Explain a deliverable to a stakeholder after the first try failed.",
      "Explain why a deadline slipped — to someone who's frustrated.",
      "Explain what you mean by 'done' to a peer who thinks they're done.",
      "Explain a process the team doesn't like, without sounding bureaucratic.",
    ],
  },
};
  ...
  for (const [exIdx, ex] of exercises.entries()) {
    ...
    for (const [goalIdx, goal] of GOALS.entries()) {
      ...
      for (const tr of triples) {
        ...
        list.push(makePrompt(tr.text, tr.difficulty, ["other", goal]));
      }
    }
...
for (const ins of inserts) {
  if (!catalog.exercises.find(e => e.name === ins.name)) missing.push(ins.name);
}
if (missing.length) {
  console.error("missing exercises in catalog:", missing);
  process.exit(1);
}
...
for (const ins of inserts) {
  ...
  for (const p of ins.prompts) {
    ...
    if (existingText.has(key)) {
      const goalTag = p.tags.find(t => t !== "other") || "oth";
