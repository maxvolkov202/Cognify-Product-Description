...
console.log('MOCK REPS since 08-10:'); for (const u of users) console.log(u.created_at.toISOString().slice(0,16), u.email, u.attempt_kind, Math.round(u.duration_ms/1000)+'s', u.tlen+'ch', u.composite_score);
...
console.log('\nBY USER since 08-10:'); console.table(byEmail);
