 ...
 * cares more about adaptability than a decision explainer (CDI) does.
 *
 ...
 *
 * Mappings (v2.0.0 rubric, WS-1 rename):
 ...
 *   his presence    → our thinking_quality + adaptability
 */
...
> = {
  ...
  // —— Sales / persuasion ——————————————————
  pspa: { adaptability: 1.3, thinking_quality: 1.2, clarity: 1.1 },
  fab: { adaptability: 1.3, conciseness: 1.2 },
  aida: { adaptability: 1.3, thinking_quality: 1.2, conciseness: 1.1 },

  // —— Feedback / interpersonal ——————————————————
  bie: { adaptability: 1.3, clarity: 1.2, thinking_quality: 1.1 },

  // —— Interview / behavioral ——————————————————
  star: { structure: 1.3, delivery: 1.2, clarity: 1.1 },

  // —— Narrative / status ——————————————————
  ppf: { structure: 1.2, adaptability: 1.2, delivery: 1.1 },
