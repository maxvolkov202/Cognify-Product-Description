import { Clock, User, Layers, TrendingUp } from "lucide-react";
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span>{rep.timeConstraint}s limit</span>
                    </div>
                    {rep.totalPausedTime > 0 && (
                      <div className="flex items-center gap-1.5">
                        <span className="text-yellow-600">⏸ {rep.totalPausedTime}s paused</span>
                      </div>
                    )}
                    {/* Rep Type Badge */}
